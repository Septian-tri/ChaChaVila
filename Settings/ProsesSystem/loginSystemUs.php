                        ...
                        if(preg_match('/^[\s]*$/', $_POST["password"])){
                            ...
                            if(strlen($_POST["password"]) < 8){
                                ...
                                function cekDataUdahAdaAtauBelum($koneksi, $data, $valData){
                                    ...
                                    $cekuserdata = mysqli_query($koneksi, "SELECT ".$data." FROM userdata WHERE  ".$data." = BINARY('".$valData."') ");
                                    ...
                                    $queryDataPengguna = mysqli_query($koneksi,"SELECT email FROM userdata WHERE  email = BINARY('$emailPengguna') ");
                                    ...
                                    if(!$queryDataPengguna){
                                        ...
                                        if(mysqli_num_rows($queryDataPengguna) !== 1){
                                            ...
                                            $querySandiPengguna = mysqli_query($koneksi,"SELECT email, password, typeakun, idrandom, typepengguna FROM userdata WHERE  email = BINARY('$emailPengguna') and password = BINARY('".$password."') ");
                                            ...
                                            if(!$querySandiPengguna){
                                                ...
                                                if(mysqli_num_rows($querySandiPengguna) !== 1){
                                                    ...
                                                    $cekTokenSementara = mysqli_query($koneksi, "SELECT idrandom FROM temptokenmasuk WHERE  idrandom = BINARY('".$idrandom."') ");
